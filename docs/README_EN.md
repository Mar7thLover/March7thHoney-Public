...
> A game server project aiming for one word: **perfection**.
...
- [ ] Improve Currency War & Divergent Universe
- [ ] Fill remaining quests and special trigger logic
- [ ] Continue improving settlement and sync stability in some modes
- [ ] Expand event-mode gameplay coverage
- [ ] Keep fixing known minor UI/state-sync issues
